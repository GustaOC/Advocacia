  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-all duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        // ✅ CORREÇÃO APLICADA AQUI: Removido o sufixo '-DEFAULT' das classes de cor
        primary: "bg-brand text-primary-foreground shadow-lg hover:bg-brand/90 transform hover:-translate-y-px",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline: "border border-input bg-background hover:bg-accent hover:text-accent-foreground",
        // ✅ CORREÇÃO APLICADA AQUI: Removido o sufixo '-DEFAULT' das classes de cor
        secondary: "border-2 border-brand/20 text-brand bg-white hover:bg-brand/5",
